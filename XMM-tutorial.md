...
Additionally, you can use <code> &&(PI in [200:10000])</code> to select a certain energy rane for which you want to extract your lightcurve for. In this example, it corresponds to a range between 0.2-10 keV.
